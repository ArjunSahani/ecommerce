...
move_uploaded_file($image1,"../assets/imgs/".$image_name2);
move_uploaded_file($image1,"../assets/imgs/".$image_name3);
move_uploaded_file($image1,"../assets/imgs/".$image_name4);
...
if($stmt->execute()){
    ...
    header('location: products.php?product_failed=Error occred, try again');
}
